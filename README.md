...
| Target Group unhealthy        | Health Check path 불일치, Security Group 인바운드 누락, Target Group 포트 설정 오류        | Health Check 경로, 서비스 응답, Target Group 포트, Security Group 규칙 조정        | 해결    |
