...
![Legacy Service Control Flow](../architecture/docs_03-deployment-flow_legacy-service-control-flow.png)
...
![Docker Image Based Deployment Flow](../architecture/docs_03-deployment-flow_docker-image-based-deployment-flow.png)
...
![ECS Service Control Flow](../architecture/docs_03-deployment-flow_ecs-service-control-flow.png)
