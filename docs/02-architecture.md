...
**Evidence**
- DS awsvpc Task Definition: `../evidence/04-troubleshooting/4.1-resource-constraint-network-mode/01-current-ds-awsvpc-task-definition.json`
- WS bridge Task Definition: `../evidence/04-troubleshooting/4.1-resource-constraint-network-mode/02-current-ws-bridge-task-definition.json`
- Network Mode 결정 요약: `../evidence/04-troubleshooting/4.1-resource-constraint-network-mode/03-network-mode-decision-summary.md`
...
**Evidence**
- WS ALB Target Healthy: `../evidence/02-load-balancer/alb-ws-target-healthy.png`
- NLB Listener 구성: `../evidence/02-load-balancer/nlb-listeners.png`
- DS 33001 Target Healthy: `../evidence/02-load-balancer/tg-ds-33001-healthy.png`
...
**Evidence**
- Cloud Map A Record 설정: `../evidence/04-troubleshooting/4.2-cloudmap-srv-compatibility/01-cloudmap-ds-service-a-record.png`
- DS DNS 조회 성공: `../evidence/04-troubleshooting/4.2-cloudmap-srv-compatibility/02-cloudmap-ds-nslookup-success.txt`
- DS 내부 포트 연결 성공: `../evidence/04-troubleshooting/4.2-cloudmap-srv-compatibility/03-cloudmap-ds-port-connectivity-success.txt`
